...
- **When (UTC):** 2026-06-27T21:53:40Z → 2026-06-27T21:53:40Z (0.0 h)
...
|---|---:|---:|
| `distance_from_shore` | 10146.060 | +0.176 |
| `distance_from_port` | 4313.498 | -0.127 |
| `speed_roll_std` | 0.000 | -0.033 |
| `speed` | 0.100 | +0.032 |
| `hour_cos` | 0.850 | +0.030 |
...
- **Integrity (SHA-256 of canonical facts):** `2dcf9cbe064ab5e25016ebc6ff58e89bf0edede8fe567c12320457b51c683e53`
