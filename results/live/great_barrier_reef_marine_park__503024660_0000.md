...
- **When (UTC):** 2026-06-27T15:07:50Z → 2026-06-27T15:07:50Z (0.0 h)
...
|---|---:|---:|
| `distance_from_shore` | 10148.774 | +0.190 |
| `distance_from_port` | 4320.430 | -0.126 |
| `speed` | 0.000 | +0.042 |
| `speed_roll_std` | 0.000 | -0.023 |
| `hour_sin` | -0.728 | +0.005 |
...
- **Integrity (SHA-256 of canonical facts):** `b10575d6f3882cac5fb47895a5fcb70f447be51061c2b4c84eaa752dda873b25`
