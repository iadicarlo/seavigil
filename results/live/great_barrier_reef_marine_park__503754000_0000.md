...
|---|---:|---:|
| `distance_from_shore` | 8701.980 | +0.193 |
| `distance_from_port` | 1282.045 | -0.112 |
| `speed` | 0.000 | +0.031 |
...
- **Integrity (SHA-256 of canonical facts):** `9dd6d77fee86437028271173577b3dd465960ae5bb86701098fc34cab163eaed`
