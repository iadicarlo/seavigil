...
|---|---:|---:|
| `distance_from_shore` | 9659.832 | +0.169 |
| `distance_from_port` | 2050.998 | -0.132 |
| `speed` | 0.000 | +0.029 |
...
- **Integrity (SHA-256 of canonical facts):** `7bd3f18efd99616b74dca8a7afa6ce8d88fb191ae43cfb64609c351a0c98159e`
