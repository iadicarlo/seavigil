...
- **Apparent fishing:** 636 of 672 in-MPA positions; mean p=0.91, max p=1.00
- **Where:** -4.102, -171.864 (centroid)
...
_mean per-position SHAP (fishing class) over the incident's fishing positions (sampled 50 of 636)._

| feature | mean value | mean SHAP |
|---|---:|---:|
| `speed_roll_mean` | 3.450 | +0.151 |
| `speed` | 3.516 | +0.136 |
| `distance_from_shore` | 51754.324 | +0.078 |
| `distance_from_port` | 144953.567 | +0.017 |
| `hour_cos` | -0.156 | +0.017 |
...
- **Integrity (SHA-256 of canonical facts):** `0e554cb5825516b48726db3e2ccdabbf988aea6707bbf027f2262885ad740f83`
