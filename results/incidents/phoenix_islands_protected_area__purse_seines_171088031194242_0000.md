...
- **Apparent fishing:** 1 of 86 in-MPA positions; mean p=0.52, max p=0.52
...
|---|---:|---:|
| `distance_from_shore` | 99702.117 | +0.031 |
| `speed` | 0.400 | +0.028 |
| `distance_from_port` | 248995.906 | -0.025 |
| `hour_sin` | -0.976 | -0.025 |
| `hour_cos` | 0.216 | -0.019 |
...
- **Integrity (SHA-256 of canonical facts):** `69ec0064984b1eb9f6367d1e0980536a593956b7172e01c68c133acee7950332`
