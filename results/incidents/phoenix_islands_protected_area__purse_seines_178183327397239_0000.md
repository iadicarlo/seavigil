...
- **Apparent fishing:** 92 of 172 in-MPA positions; mean p=0.67, max p=0.90
- **Where:** -3.477, -171.916 (centroid)
...
|---|---:|---:|
| `speed` | 2.636 | +0.127 |
| `speed_roll_mean` | 2.941 | +0.111 |
| `distance_from_port` | 76022.959 | -0.044 |
| `hour_cos` | -0.059 | -0.031 |
| `hour_sin` | 0.200 | -0.026 |
...
- **Integrity (SHA-256 of canonical facts):** `9d8d50c0f96454a365e08e11524046c43022855eee80b1f48986f2c93072fb2b`
